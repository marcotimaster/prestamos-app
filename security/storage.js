...
class Storage {
    static get values() {
        return {
            ...
            contratoPrestamoFotoFirma: {
                id: 'contratoPrestamoFotoFirma',
                folder: 'tenant/:tenantId/contratoPrestamo/fotoFirma',
                maxSizeInBytes: 100 * 1024 * 1024,
            },
            pagoEvidenciaPago: {
                id: 'pagoEvidenciaPago',
                folder: 'tenant/:tenantId/pago/evidenciaPago',
                maxSizeInBytes: 100 * 1024 * 1024,
            },
        };
    }
