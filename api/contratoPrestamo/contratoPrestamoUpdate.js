...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.contratoPrestamoEdit);
        const payload = yield new contratoPrestamoService_1.default(req).update(req.params.id, req.body.data);
...
//# sourceMappingURL=contratoPrestamoUpdate.js.map