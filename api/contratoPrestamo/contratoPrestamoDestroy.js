...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.contratoPrestamoDestroy);
        yield new contratoPrestamoService_1.default(req).destroyAll(req.query.ids);
        const payload = true;
...
//# sourceMappingURL=contratoPrestamoDestroy.js.map