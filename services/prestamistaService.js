...
class PrestamistaService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                data.tags = yield tagRepository_1.default.filterIdsInTenant(data.tags, Object.assign(Object.assign({}, this.options), { session }));
                const record = yield prestamistaRepository_1.default.create(data, Object.assign(Object.assign({}, this.options), { session }));
                yield mongooseRepository_1.default.commitTransaction(session);
                return record;
            }
            catch (error) {
                yield mongooseRepository_1.default.abortTransaction(session);
                mongooseRepository_1.default.handleUniqueFieldError(error, this.options.language, 'prestamista');
                throw error;
            }
        });
    }
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                data.tags = yield tagRepository_1.default.filterIdsInTenant(data.tags, Object.assign(Object.assign({}, this.options), { session }));
                const record = yield prestamistaRepository_1.default.update(id, data, Object.assign(Object.assign({}, this.options), { session }));
                yield mongooseRepository_1.default.commitTransaction(session);
                return record;
            }
            catch (error) {
    ...
    destroyAll(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const id of ids) {
                    yield prestamistaRepository_1.default.destroy(id, Object.assign(Object.assign({}, this.options), { session }));
                }
                yield mongooseRepository_1.default.commitTransaction(session);
            }
            catch (error) {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return prestamistaRepository_1.default.findById(id, this.options);
        });
    }
    findAllAutocomplete(search, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            return prestamistaRepository_1.default.findAllAutocomplete(search, limit, this.options);
        });
    }
    findAndCountAll(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return prestamistaRepository_1.default.findAndCountAll(args, this.options);
        });
    }
    ...
    _isImportHashExistent(importHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield prestamistaRepository_1.default.count({
                importHash,
            }, this.options);
            return count > 0;
        });
...
exports.default = PrestamistaService;
//# sourceMappingURL=prestamistaService.js.map